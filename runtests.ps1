...
nugettools\OpenCover.4.6.519\tools\OpenCover.Console.exe -register:user -target:"nugettools\xunit.runner.console.2.1.0\tools\xunit.console.x86.exe"  -targetargs:"EasyCrypto.Tests\bin\Debug\EasyCrypto.Tests.dll EasyCrypto.Tests\bin\Debug\EasyCrypto.dll -noshadow" -output:"coverageopencover.xml" -filter:"+[EasyCrypto*]* -[EasyCrypto.T*]* -[EasyCrypto*]EasyCrypto.Exc* -[xunit*]*"
